...
<form action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="post">
    ...
    <div>
        <label>
            Name:<br /><input autocomplete="off" type="text" name="Name" required="required" placeholder="Full Name (required)" title="Name is required" tabindex="10" size="44" autofocus />
        </label>
    </div>
    <div>
        <label>
            Email:<br /><input autocomplete="off" type="email" name="Email" required="required" placeholder="Email (required)" title="A valid email is required" tabindex="20" size="44" />
        </label>
    </div>
    ...
    <div>
        <label>
            ...
            <select class="hearUs" name="How_Did_You_Hear_About_Us?" required="required" title="How You Heard is required" tabindex="30">
